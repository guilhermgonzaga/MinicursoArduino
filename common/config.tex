...
% Diretórios comum e local de imagens (respectivamente)
...
% Abstrai o caminho de uma sketch a partir da raiz do documento
\newcommand{\SketchBasename}[1]{sketches/#1/#1}

% Insere o código de uma sketch e ignora as linhas do identificador SPDX
\newcommand{\SketchCode}[1]{\inputminted[firstline=3]{arduino}{\SketchBasename{#1}.ino}}

% Insere o diagrama de uma sketch e repassa opções para includegraphics
\newcommand{\SketchDiagram}[2][]{\includegraphics[#1]{\SketchBasename{#2}.pdf}}
...
% O título será definido em cada slide
\subtitle{Minicurso de Arduino}
\author[Estudantes de E.C. da UFMS]{}
\institute{%
	\begin{columns}[c,onlytextwidth]
	\column{0.77\linewidth}
		Produzido independentemente por e para \\ estudantes de Engenharia de Computação \\ da FACOM/UFMS.
		\vspace{\medskipamount}\\
	\column{0.23\linewidth}
		\includegraphics[width=\linewidth]{facomGraph}
	\end{columns}%
}
\date{{\normalsize compilado em \the\year}}
