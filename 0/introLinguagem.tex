...
\begin{frame}[fragile]{\insertsection: \insertsubsection}
  ...
  \end{minted}
%  \inputminted[firstline=1,lastline=4]{arduino}{sketches/introLinguagem/.funcoes.ino}
...
\begin{frame}[fragile]{\insertsection: \insertsubsection}
  ...
  \end{minted}
%  \inputminted[firstline=38,lastline=44]{arduino}{sketches/introLinguagem/.funcoes.ino}
...
\begin{frame}[fragile]{\insertsection: \insertsubsection}
  ...
  \column{0.5\linewidth}
    ...
    \end{minted}
%    \inputminted[firstline=06,lastline=13]{arduino}{sketches/introLinguagem/.funcoes.ino}
  \column{0.5\linewidth}
    \begin{minted}{arduino}
    ...
    \end{minted}
%    \inputminted[firstline=15,lastline=17]{arduino}{sketches/introLinguagem/.funcoes.ino}
    \vspace{-\bigskipamount}\\
    \begin{minted}{arduino}
    ...
    \end{minted}
%    \inputminted[firstline=19,lastline=23]{arduino}{sketches/introLinguagem/.funcoes.ino}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]{\insertsection: \insertsubsection}
  ...
  \end{minted}
%  \inputminted[firstline=25,lastline=36]{arduino}{sketches/introLinguagem/.funcoes.ino}
\end{frame}
...
%    \inputminted[firstline=20,lastline=22]{arduino}{sketches/introLinguagem/.for.ino}
  \column{0.5\linewidth}
    ...
    \end{minted}
%    \inputminted[firstline=24,lastline=26]{arduino}{sketches/introLinguagem/.for.ino}
    \begin{minted}{arduino}
      for (int i = 1; i < n; i += 2) {
      	ações;
      }
    \end{minted}
%    \inputminted[firstline=28,lastline=30]{arduino}{sketches/introLinguagem/.for.ino}
  \end{columns}
%  \pause
