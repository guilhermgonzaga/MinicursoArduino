...
\begin{frame}{\insertsection: \insertsubsection}
	...
	\begin{description}
		...
		\item[\texttt{char}] inteiro de 8 bits
...
%		\item[\texttt{word}] inteiro não negativo de 16 bits\Highlight{**}
...
%		\item[\texttt{double}] ponto flutuante de 32 bits\Highlight{*}
		...
		\item[\texttt{void}] tipo que significa "nada"; tem usos bem específicos
...
\begin{frame}[fragile]{\insertsection: \insertsubsection}
	...
	Variáveis \textbf{de inteiros} podem representar números não negativos se modificadas com \texttt{\Highlight{unsigned}}.
	\begin{minted}{arduino}
...
\begin{frame}[fragile]{\insertsection: \insertsubsection}
	...
	\begin{itemize}
		...
		\item Parâmetros são variáveis/referências passados para a função. Referências permitem mudar variáveis no código que chama a função.
	\end{itemize}
...
\begin{frame}[fragile]{\insertsection: \insertsubsection}
	...
	Vetores são sequências de variáveis do mesmo tipo.
